...
public class TabFragmentBusinessAdmin extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        View rootView = inflater.inflate(R.layout.fragment_tab_business_admin, container, false);
        ...
        fbtn = rootView.findViewById(R.id.id_business_floatingActionButton);
